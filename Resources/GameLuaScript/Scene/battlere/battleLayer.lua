...
local linefo = require "GameLuaScript/Scene/battlere/battleCardInfo"
function battleLayer:new(point_x,point_y,params)
	...
	--返回按钮按钮
	local back_btn = require"GameLuaScript/Common/KNBtn"
	--local group = RadioGroup:new()
	local temps

	    temps = back_btn:new("image/buttonUI/home/button/",{"def.png","pre.png"},20,125,
	    		{
	    			front = "image/buttonUI/home/other/back/back.png",
	    			highLight = true,
	    			scale = true,
					--selectable = true,
	    			callback=
	...
	--保存
	local save_btn = require"GameLuaScript/Common/KNBtn"
	--local group = RadioGroup:new()
	local temps

	    temps = save_btn :new("image/buttonUI/home/button/",{"def.png","pre.png"},255,125,
	    		{
	    			front = "image/buttonUI/home/other/save/save.png",
	    			highLight = true,
	    			scale = true,
					--selectable = true,
	    			callback=

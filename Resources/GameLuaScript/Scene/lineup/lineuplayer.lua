...
function lineuplayer:new(x,y)
	...
	local sv = KNScrollView:new(56,680,300,200,0,true)
	local card
	...
	---[[英雄信息滑块]]
	local infolayer = require"GameLuaScript/Scene/lineup/lineupInfo"
	local ksv = KNScrollView:new(0,100,480,550,0,true,1)
	local infos
	local card_x = 56
	local card_y = 680
	...
	local temps
	    ...
	    temps = btns:new("image/buttonUI/Lineup/lineup/",{"def.png","pre.png"},390,675,
	    		{
	    			--front = v[1],
	    			highLight = true,
	    			scale = true,

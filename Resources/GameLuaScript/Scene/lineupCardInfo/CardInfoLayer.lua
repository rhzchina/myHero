...
function cardInfolayer:new(data,x,y)
	...
	this.layer:addChild(hero_bg)
		...
		local hero_cald = CCSprite:create("image/myhero/big/"..DATA_CardInfo:get("card_id")..".png")----英雄
	...
	local temps
	    ...
	    temps = btns:new("image/buttonUI/cardinfo/Replace/",{"def.png","pre.png"},30,125,
	    		{
	    			--front = v[1],
	    			highLight = true,
	    			scale = true,
	    ...
	    temp = btns:new("image/buttonUI/cardinfo/Gong/",{"def.png","pre.png"},250,125,
	    		{
	    			--front = v[1],
	    			highLight = true,
	    			scale = true,

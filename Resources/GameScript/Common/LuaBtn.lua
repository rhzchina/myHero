...
function LuaBtn:new(path, file, x, y, params, group)
	local this = {}
...
function LuaBtn:getLayer()
	return self.layer
end

function LuaBtn:setState(state)
	self.state = state
	local done = false
...
function LuaBtn:select(selecte,callback)
...
function LuaBtn:showBtn(bool)
	self.layer:setVisible(bool)
end
--当前显示状态
function LuaBtn:getShow()
	self.layer:isVisible()
end

function LuaBtn:setEnable(bool)
...
function LuaBtn:getId()
	return self.params["id"]
end

function LuaBtn:setOther(sp)

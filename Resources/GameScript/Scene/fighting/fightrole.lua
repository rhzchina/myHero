...
local position = {
	{
		...
		{ccp(20, 200), ccp(175, 230), ccp(320, 200), ccp(0, 0), ccp(0, 0)},
		{ccp(0, 0), ccp(0, 0), ccp(0, 0), ccp(0, 0), ccp(0, 0), ccp(0, 0),}
	},  --我方英雄
	{
		{ccp(10, 0)},
		{ccp(20, 0), ccp(0, 0)},
		{ccp(30, 0), ccp(0, 0), ccp(0, 0)},
		{ccp(40, 0), ccp(0, 0), ccp(0, 0), ccp(0, 0)},
		{ccp(50, 0), ccp(0, 0), ccp(0, 0), ccp(0, 0), ccp(0, 0)},
			...
			array:addObject(CCCallFunc:create(    --起手完成后开始播放特效
				function() 
					if self.params["effect"] then
						self.params["effect"]:showByType("11101",self.x,self.y,0.04,
						{
							callback = 
							function()
